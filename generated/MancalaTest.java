...
public class MancalaTest extends TestCase
{
   ...
   @Property( name = PROPERTY_ALEX )
   public MancalaTest withAlex (Player value)
   {
      setAlex (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_GAME )
   public MancalaTest withGame (Game value)
   {
      setGame (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_LISA )
   public MancalaTest withLisa (Player value)
   {
      setLisa (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_A_CUP1 )
   public MancalaTest withACup1 (Cup value)
   {
      setACup1 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_A_CUP2 )
   public MancalaTest withACup2 (Cup value)
   {
      setACup2 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_A_CUP3 )
   public MancalaTest withACup3 (Cup value)
   {
      setACup3 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_A_CUP4 )
   public MancalaTest withACup4 (Cup value)
   {
      setACup4 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_A_CUP5 )
   public MancalaTest withACup5 (Cup value)
   {
      setACup5 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_A_CUP6 )
   public MancalaTest withACup6 (Cup value)
   {
      setACup6 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_A_MANCALA )
   public MancalaTest withAMancala (Kahala value)
   {
      setAMancala (value);
      return this;
   }
   ...
   public void assertStep1 ()
   {
      ...
      try 
      {
         ...
         // check link next from aCup1 to aCup2
         JavaSDM.ensure (aCup2.equals (aCup1.getRightCup ()), "check link next from aCup1 to aCup2");
   ...
   @Property( name = PROPERTY_L_CUP1 )
   public MancalaTest withLCup1 (Cup value)
   {
      setLCup1 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_L_CUP2 )
   public MancalaTest withLCup2 (Cup value)
   {
      setLCup2 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_L_CUP3 )
   public MancalaTest withLCup3 (Cup value)
   {
      setLCup3 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_L_CUP4 )
   public MancalaTest withLCup4 (Cup value)
   {
      setLCup4 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_L_CUP5 )
   public MancalaTest withLCup5 (Cup value)
   {
      setLCup5 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_L_CUP6 )
   public MancalaTest withLCup6 (Cup value)
   {
      setLCup6 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_L_MANCALA )
   public MancalaTest withLMancala (Kahala value)
   {
      setLMancala (value);
      return this;
   }
   ...
   public void setUp ()
   {
      ...
      try 
      {
         ...
         // create link has from Lisa to lMancala
         Lisa.setKahala (lMancala);
