...
public class Scenario_12Test extends TestCase
{
   ...
   @Property( name = PROPERTY_ALEX )
   public Scenario_12Test withAlex (Player value)
   {
      setAlex (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_GAME )
   public Scenario_12Test withGame (Game value)
   {
      setGame (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_LISA )
   public Scenario_12Test withLisa (Player value)
   {
      setLisa (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_A_CUP1 )
   public Scenario_12Test withACup1 (Cup value)
   {
      setACup1 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_A_CUP2 )
   public Scenario_12Test withACup2 (Cup value)
   {
      setACup2 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_A_CUP3 )
   public Scenario_12Test withACup3 (Cup value)
   {
      setACup3 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_A_CUP4 )
   public Scenario_12Test withACup4 (Cup value)
   {
      setACup4 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_A_CUP5 )
   public Scenario_12Test withACup5 (Cup value)
   {
      setACup5 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_A_CUP6 )
   public Scenario_12Test withACup6 (Cup value)
   {
      setACup6 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_A_MANCALA )
   public Scenario_12Test withAMancala (Kahala value)
   {
      setAMancala (value);
      return this;
   }
   ...
   public void assertStep1 ()
   {
      ...
      try 
      {
         ...
         // check link isActive from Alex to Game
         JavaSDM.ensure (Game.equals (Alex.getTurn ()), "check link isActive from Alex to Game");

         // destroy link isActive from Alex to Game
         Alex.setTurn (null);
         // create object lCup6
         lCup6 = new Cup("1");
   ...
   @Property( name = PROPERTY_L_CUP1 )
   public Scenario_12Test withLCup1 (Cup value)
   {
      setLCup1 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_L_CUP2 )
   public Scenario_12Test withLCup2 (Cup value)
   {
      setLCup2 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_L_CUP3 )
   public Scenario_12Test withLCup3 (Cup value)
   {
      setLCup3 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_L_CUP4 )
   public Scenario_12Test withLCup4 (Cup value)
   {
      setLCup4 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_L_CUP5 )
   public Scenario_12Test withLCup5 (Cup value)
   {
      setLCup5 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_L_CUP6 )
   public Scenario_12Test withLCup6 (Cup value)
   {
      setLCup6 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_L_MANCALA )
   public Scenario_12Test withLMancala (Kahala value)
   {
      setLMancala (value);
      return this;
   }
