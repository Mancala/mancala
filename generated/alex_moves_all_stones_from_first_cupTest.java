...
public class alex_moves_all_stones_from_first_cupTest extends TestCase
{
    ...
    * <pre>
    *           0..1     object_Alex     0..1
    * alex_moves_all_stones_from_first_cupTest ------------------------> Player
    *           test               Alex
    * </pre>
    */
   ...
   @Property( name = PROPERTY_ALEX )
   public alex_moves_all_stones_from_first_cupTest withAlex (Player value)
   {
      setAlex (value);
      return this;
   }
    ...
    * <pre>
    *           0..1     object_Game     0..1
    * alex_moves_all_stones_from_first_cupTest ------------------------> Game
    *           test               Game
    * </pre>
    */
   ...
   @Property( name = PROPERTY_GAME )
   public alex_moves_all_stones_from_first_cupTest withGame (Game value)
   {
      setGame (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_LISA )
   public alex_moves_all_stones_from_first_cupTest withLisa (Player value)
   {
      setLisa (value);
      return this;
   }
    ...
    * alex_moves_all_stones_from_first_cupTest ------------------------> Cup
    *           test               aCup1
    * </pre>
    */
   ...
   @Property( name = PROPERTY_A_CUP1 )
   public alex_moves_all_stones_from_first_cupTest withACup1 (Cup value)
   {
      setACup1 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_A_CUP2 )
   public alex_moves_all_stones_from_first_cupTest withACup2 (Cup value)
   {
      setACup2 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_A_CUP3 )
   public alex_moves_all_stones_from_first_cupTest withACup3 (Cup value)
   {
      setACup3 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_A_CUP4 )
   public alex_moves_all_stones_from_first_cupTest withACup4 (Cup value)
   {
      setACup4 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_A_CUP5 )
   public alex_moves_all_stones_from_first_cupTest withACup5 (Cup value)
   {
      setACup5 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_A_CUP6 )
   public alex_moves_all_stones_from_first_cupTest withACup6 (Cup value)
   {
      setACup6 (value);
      return this;
   }
    ...
    * alex_moves_all_stones_from_first_cupTest ------------------------> Kahala
    *           test               aMancala
    * </pre>
    */
   ...
   @Property( name = PROPERTY_A_MANCALA )
   public alex_moves_all_stones_from_first_cupTest withAMancala (Kahala value)
   {
      setAMancala (value);
      return this;
   }
   ...
   public void assertStep1 ()
   {
      ...
      try 
      {
         ...
         // check object aCup6 is really bound
         JavaSDM.ensure ( aCup6 != null, "check object aCup6 is really bound" );
         // check object aMancala is really bound
         JavaSDM.ensure ( aMancala != null, "check object aMancala is really bound" );
         ...
         // check isomorphic binding between objects lCup1 and aCup6
         JavaSDM.ensure ( !lCup1.equals (aCup6), "check isomorphic binding between objects lCup1 and aCup6" );

         // check isomorphic binding between objects lCup2 and aCup6
         JavaSDM.ensure ( !lCup2.equals (aCup6), "check isomorphic binding between objects lCup2 and aCup6" );

         // check isomorphic binding between objects lCup3 and aCup6
         JavaSDM.ensure ( !lCup3.equals (aCup6), "check isomorphic binding between objects lCup3 and aCup6" );

         // check isomorphic binding between objects lCup4 and aCup6
         JavaSDM.ensure ( !lCup4.equals (aCup6), "check isomorphic binding between objects lCup4 and aCup6" );

         // check isomorphic binding between objects lCup5 and aCup6
         JavaSDM.ensure ( !lCup5.equals (aCup6), "check isomorphic binding between objects lCup5 and aCup6" );

         // check isomorphic binding between objects lCup6 and aCup6
         JavaSDM.ensure ( !lCup6.equals (aCup6), "check isomorphic binding between objects lCup6 and aCup6" );

         // check isomorphic binding between objects lMancala and aMancala
         JavaSDM.ensure ( !lMancala.equals (aMancala), "check isomorphic binding between objects lMancala and aMancala" );
         ...
         // check isomorphic binding between objects lCup5 and lCup4
         JavaSDM.ensure ( !lCup5.equals (lCup4), "check isomorphic binding between objects lCup5 and lCup4" );
         ...
         // check link has from Alex to aMancala
         JavaSDM.ensure (aMancala.equals (Alex.getKahala ()), "check link has from Alex to aMancala");

         // check link has from Lisa to lMancala
         JavaSDM.ensure (lMancala.equals (Lisa.getKahala ()), "check link has from Lisa to lMancala");

         // check link next from aMancala to aCup6
         JavaSDM.ensure (aCup6.equals (aMancala.getCup ()), "check link next from aMancala to aCup6");

         // check link next from aCup6 to lCup1
         JavaSDM.ensure (lCup1.equals (aCup6.getRightCup ()), "check link next from aCup6 to lCup1");
         ...
         // check link next from lCup5 to lCup4
         JavaSDM.ensure (lCup4.equals (lCup5.getLeftCup ()), "check link next from lCup5 to lCup4");

         // check link next from lCup6 to lCup5
         JavaSDM.ensure (lCup5.equals (lCup6.getLeftCup ()), "check link next from lCup6 to lCup5");

         // check link next from lMancala to lCup6
         JavaSDM.ensure (lCup6.equals (lMancala.getCup ()), "check link next from lMancala to lCup6");
         ...
         // create link isActive from Game to Lisa
         Game.setIsActive (Lisa);

         // create link next from aCup1 to lCup6
         aCup1.setLeftCup (lCup6);
   ...
   @Property( name = PROPERTY_L_CUP1 )
   public alex_moves_all_stones_from_first_cupTest withLCup1 (Cup value)
   {
      setLCup1 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_L_CUP2 )
   public alex_moves_all_stones_from_first_cupTest withLCup2 (Cup value)
   {
      setLCup2 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_L_CUP3 )
   public alex_moves_all_stones_from_first_cupTest withLCup3 (Cup value)
   {
      setLCup3 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_L_CUP4 )
   public alex_moves_all_stones_from_first_cupTest withLCup4 (Cup value)
   {
      setLCup4 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_L_CUP5 )
   public alex_moves_all_stones_from_first_cupTest withLCup5 (Cup value)
   {
      setLCup5 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_L_CUP6 )
   public alex_moves_all_stones_from_first_cupTest withLCup6 (Cup value)
   {
      setLCup6 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_L_MANCALA )
   public alex_moves_all_stones_from_first_cupTest withLMancala (Kahala value)
   {
      setLMancala (value);
      return this;
   }
   ...
   public void setUp ()
   {
      ...
      try 
      {
         ...
         // create link next from lMancala to lCup6
         lMancala.setCup (lCup6);
   ...
   public void testalex_moves_all_stones_from_first_cup ()
   {
      boolean fujaba__Success = false;
